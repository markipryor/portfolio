...
const driverStandings = [
  { pos: 1,  name: "Lando Norris",       constructor: "McLaren",       points: 324, wins: 6, poles: 5, podiums: 15 },
  { pos: 2,  name: "Oscar Piastri",      constructor: "McLaren",       points: 310, wins: 6, poles: 4, podiums: 13 },
  { pos: 3,  name: "Max Verstappen",     constructor: "Red Bull",      points: 298, wins: 5, poles: 7, podiums: 11 },
  { pos: 4,  name: "George Russell",     constructor: "Mercedes",      points: 229, wins: 2, poles: 2, podiums: 8  },
  ...
  { pos: 7,  name: "Kimi Antonelli",     constructor: "Mercedes",      points: 92,  wins: 0, poles: 0, podiums: 1  },
  { pos: 8,  name: "Alexander Albon",    constructor: "Williams",      points: 70,  wins: 0, poles: 0, podiums: 0  },
  { pos: 9,  name: "Nico Hülkenberg",    constructor: "Sauber",        points: 41,  wins: 0, poles: 0, podiums: 1  },
  { pos: 10, name: "Isack Hadjar",       constructor: "RB",            points: 38,  wins: 0, poles: 0, podiums: 1  },
  { pos: 11, name: "Fernando Alonso",    constructor: "Aston Martin",  points: 37,  wins: 0, poles: 0, podiums: 0  },
  { pos: 12, name: "Oliver Bearman",     constructor: "Haas",          points: 30,  wins: 0, poles: 0, podiums: 0  },
  { pos: 13, name: "Liam Lawson",        constructor: "RB",            points: 30,  wins: 0, poles: 0, podiums: 0  },
...
const constructorStandings = [
  { pos: 1,  name: "McLaren",       points: 634, wins: 12 },
  { pos: 2,  name: "Ferrari",       points: 324, wins: 0  },
  { pos: 3,  name: "Mercedes",      points: 321, wins: 2  },
  { pos: 4,  name: "Red Bull",      points: 318, wins: 5  },
  { pos: 5,  name: "Williams",      points: 99,  wins: 0  },
  { pos: 6,  name: "RB",            points: 68,  wins: 0  },
  { pos: 7,  name: "Aston Martin",  points: 65,  wins: 0  },
  { pos: 8,  name: "Sauber",        points: 60,  wins: 0  },
  { pos: 9,  name: "Haas",          points: 56,  wins: 0  },
  { pos: 10, name: "Alpine",        points: 15,  wins: 0  },
];
...
const races2025 = [
  ...
  { round: 9,  name: "Canada",        date: "15 Jun", winner: "George Russell",  team: "Mercedes",  sprint: false },
  { round: 10, name: "Austria",       date: "29 Jun", winner: "Lando Norris",    team: "McLaren",   sprint: false },
  { round: 11, name: "Great Britain", date: "6 Jul",  winner: "Lando Norris",    team: "McLaren",   sprint: false },
  { round: 12, name: "Belgium",       date: "27 Jul", winner: "Oscar Piastri",   team: "McLaren",   sprint: true  },
  { round: 13, name: "Hungary",       date: "3 Aug",  winner: "Lando Norris",    team: "McLaren",   sprint: false },
  { round: 14, name: "Dutch",         date: "31 Aug", winner: "Oscar Piastri",   team: "McLaren",   sprint: false },
  { round: 15, name: "Italy",         date: "7 Sep",  winner: "Max Verstappen",  team: "Red Bull",  sprint: false },
  { round: 16, name: "Azerbaijan",    date: "21 Sep", winner: "Max Verstappen",  team: "Red Bull",  sprint: false },
  { round: 17, name: "Singapore",     date: "5 Oct",  winner: "George Russell",  team: "Mercedes",  sprint: false },
  { round: 18, name: "United States", date: "19 Oct", winner: "Max Verstappen",  team: "Red Bull",  sprint: true  },
  { round: 19, name: "Mexico City",   date: "26 Oct", winner: "Lando Norris",    team: "McLaren",   sprint: false },
];
            ...
            <div key={d.name} className="bg-zinc-900 border border-zinc-800 rounded-lg px-4 py-3 flex items-center gap-4">
              ...
              <div className="text-right min-w-[60px]">
                ...
                <div className="w-full bg-zinc-800 rounded-full h-1 mt-1">
                  <div className={`h-1 rounded-full ${teamColours[d.constructor] ?? "bg-zinc-600"}`} style={{ width: `${(d.points / maxPoints) * 100}%` }} />
                </div>
              </div>
            </div>
          ))}
          ...
          {constructorStandings.map((c) => (
            <div key={c.name} className="bg-zinc-900 border border-zinc-800 rounded-lg px-4 py-3 flex items-center gap-4">
              ...
              <div className="text-right min-w-[80px]">
                ...
                <div className="w-full bg-zinc-800 rounded-full h-1 mt-1">
                  <div className={`h-1 rounded-full ${teamColours[c.name] ?? "bg-zinc-600"}`} style={{ width: `${(c.points / constructorStandings[0].points) * 100}%` }} />
                </div>
              </div>
            </div>
          ))}
            ...
            <tbody className="divide-y divide-zinc-800/60">
              {races2025.map((r) => (
                <tr key={r.round} className="hover:bg-zinc-900/60 transition-colors">
                  ...
                  <td className="py-3 text-zinc-300">{r.winner}</td>
                  <td className="py-3">
        ...
        <div>
          <div className="flex gap-1 mb-6 w-fit bg-zinc-900 border border-zinc-800 rounded-lg p-1">
            {([ ["wins", "Most Wins"], ["poles", "Most Poles"], ["fl", "Most Fastest Laps"] ] as ["wins"|"poles"|"fl", string][]).map(([key, label]) => (
              <button key={key} onClick={() => setRecordTab(key)}
          ...
          <div className="space-y-2">
            {(recordTab === "wins" ? allTimeWins.map((r,i) => ({ name: r.name, value: r.wins, max: allTimeWins[0].wins, i }))
              : recordTab === "poles" ? allTimePoles.map((r,i) => ({ name: r.name, value: r.poles, max: allTimePoles[0].poles, i }))
